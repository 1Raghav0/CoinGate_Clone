        ...
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="list-disc list-inside text-gray-500 mb-8 max-w-md">
              <li>Access to experts for quotes and interviews.</li>
              <li>
                Information and data for your story.
              </li>
              <li>
                Media kits and high-resolution brand assets.
              </li>
              <li>
                Answers to any media-related questions you may have.
              </li>
            </ul>
