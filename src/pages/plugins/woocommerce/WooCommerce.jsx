        ...
        <div className="sm:pt-9 mt-0 rounded-container rounded-none">
          <div className="mb-9 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav id="coingate_breadcrumbs" className="flex text-white" aria-label="Breadcrumb">
              <ol role="list" className="flex flex-wrap items-center space-x-2 text-sm">
                ...
                <li className="item-current item-549 max-w-[10rem] md:max-w-none truncate">
                  <span> WooCoommerce Plugin</span>
                </li>
              </ol>
            </nav>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid items-center lg:grid-cols-2 sm:gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="col-span-1">
              <div className="">
                <h1 className="text-3xl sm:text-4xl text-white font-semibold leading-tight mb-4 sm:mb-6 max-w-2xl text-left">Accept Bitcoin & Cryptocurrency payments with WooCommerce plugin for WordPress website</h1>
                <p className="text-gray-100 text-sm sm:text-base whitespace-pre-line max-w-xl text-left">Expand payment methods of your online business with a fully automated solution for receiving crypto payments. Get paid for your goods and services in Bitcoin (BTC), Litecoin (LTC), Ether (ETH), Solana (SOL) and other cryptocurrencies using an official WooCommerce (WordPress) plugin powered by CoinGate – one of the leading cryptocurrency payment gateways worldwide.</p>
                <div className="flex flex-wrap -mr-4 -mb-4 mt-6">
                  ...
                  <a className="inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-white hover:text-gray-900 shrink-0 mr-4 mb-4 transition-colors duration-200" href="https://wordpress.org/plugins/coingate-for-woocommerce/" rel="noreferrer" target="_blank">
                    <span className="mr-2">Download WooCommerce plugin</span>
                    <svg width="8" height="12" viewBox="0 0 8 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.70492 0L0.294922 1.41L4.87492 6L0.294922 10.59L1.70492 12L7.70492 6L1.70492 0Z" fill="currentColor"></path>
                    </svg>
                  </a>
            ...
            <div className="col-span-1 mt-6 sm:mt-0">
              <div className="w-full min-h-[312px] sm:min-h-[500px] bg-no-repeat bg-center bg-contain" style={{ backgroundImage: "url('https://cdn.coingate.com/uploads/2023/09/10064120/woo-image-1-1.png')" }}></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="lg:grid-cols-2 grid grid-cols-1 gap-6 items-center">
            <div className="col-span-1 lg:order-first order-last">
              <div className="max-w-2xl">
                <p className="pre-title mb-2"></p>
                <h2 className="text-gray-900 text-4xl sm:text-5xl font-semibold leading-tight mb-6" style={{ overflowWrap: 'break-word' }}>Benefits of having CoinGate crypto payments on WooCommerce:</h2>
                <ul className="mt-4 space-y-2">
                  {[
                ...
                <div className="flex flex-wrap -mr-4 -mb-4 mt-6">
                  <a className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shrink-0 mr-4 mb-4" href="https://support.coingate.com/" rel="noreferrer" target="_blank">
                    <span className="mr-2">Connect CoinGate to your WooCommerce site</span>
                    <svg width="8" height="12" viewBox="0 0 8 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.70492 0L0.294922 1.41L4.87492 6L0.294922 10.59L1.70492 12L7.70492 6L1.70492 0Z" fill="currentColor"></path>
                    </svg>
                  </a>
      ...
      <div id="vertical-timeline__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="max-w-2xl mx-auto mb-9">
            ...
            <h2 className="text-4xl sm:text-5xl text-gray-900 font-semibold leading-tight mb-6 text-center">How to set up CoinGate’s app on WooCommerce?</h2>
      ...
      <div id="demo-contact__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="col-span-1">
              <form action="/plugins/woocommerce" method="post" className="space-y-5">
                <div>
      ...
      <div id="faq__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-20">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What cryptos can I accept with the WooCommerce plugin?", a: "You can find the up-to-date list of supported currencies in this page." },
              { q: "Am I able to use the WooCommerce plugin and collect bitcoin payments in my country?", a: "CoinGate supports 170+ countries listed here." },
              { q: "Are there any fees for accepting crypto with the WooCommerce plugin?", a: "Accept cryptocurrency payments with a little 1% fee for a processed transaction." },
              { q: "How can I test the WooCommerce plugin functionality?", a: "Sign up for the CoinGate Sandbox to test the services in a safe environment." },
              { q: "Does it take long to withdraw the funds collected via the WooCommerce plugin?", a: "Withdrawals are processed recurringly. SEPA payouts might take 1-2 business days to go through." },
