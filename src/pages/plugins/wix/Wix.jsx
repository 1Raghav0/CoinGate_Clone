        ...
        <div className="sm:pt-9 mt-0 rounded-container rounded-none">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid items-center lg:grid-cols-2 sm:gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="col-span-1">
              <div className="">
                <h1 className="text-4xl sm:text-5xl text-white font-semibold leading-tight mb-4 sm:mb-6 max-w-3xl text-left">Accept Bitcoin & Cryptocurrency Payments on Wix</h1>
                <p className="text-gray-100 text-base sm:text-lg whitespace-pre-line max-w-2xl text-left">Accept payments in Bitcoin, stablecoins and other cryptocurrencies on your Wix website by adding a new payment method to your store’s checkout.</p>
                <div className="flex flex-wrap -mr-4 -mb-4 mt-6">
                  <a className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shrink-0 mr-4 mb-4" href="https://accounts.coingate.com/register" target="_blank" rel="noopener noreferrer">
                    <span className="mr-2">Open a business account</span>
                  ...
                  <a className="inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-white hover:text-gray-900 shrink-0 mr-4 mb-4 transition-colors duration-200" href="https://support.wix.com/en/article/connecting-coingate-as-a-payment-provider-for-cryptocurrency-payments" rel="noreferrer" target="_blank">
                    <span className="mr-2">Connect CoinGate to your WIX site</span>
                    <svg width="8" height="12" viewBox="0 0 8 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.70492 0L0.294922 1.41L4.87492 6L0.294922 10.59L1.70492 12L7.70492 6L1.70492 0Z" fill="currentColor"></path>
                    </svg>
                  </a>
            ...
            <div className="col-span-1 mt-6 sm:mt-0">
              <div className="w-full min-h-[312px] sm:min-h-[500px] bg-no-repeat bg-center bg-contain" style={{ backgroundImage: "url('https://cdn.coingate.com/uploads/2023/11/10063749/WIX-3-1.png')" }}></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="lg:grid-cols-2 grid grid-cols-1 gap-6 items-center">
            <div className="col-span-1 lg:order-first order-last">
              <div className="max-w-2xl">
                <p className="pre-title mb-2"></p>
                <h2 className="text-gray-900 text-4xl sm:text-5xl font-semibold leading-tight mb-6" style={{ overflowWrap: 'break-word' }}>Benefits of having CoinGate crypto payments on Wix:</h2>
                <ul className="mt-4 space-y-2">
                  {[
      ...
      <div id="vertical-timeline__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="max-w-2xl mx-auto mb-9">
            ...
            <h2 className="text-4xl sm:text-5xl text-gray-900 font-semibold leading-tight mb-6 text-center">How to set up CoinGate’s app on Wix?</h2>
      ...
      <div id="demo-contact__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="col-span-1">
              <form action="/plugins/wix" method="post" className="space-y-5">
                <div>
      ...
      <div id="faq__block" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-20">
        <div className="bg-white rounded-[40px] p-8 md:p-14 shadow-sm max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What cryptos can I accept with the Wix web app?", a: "You can find the up-to-date list of supported currencies in this page." },
              { q: "Am I able to use the Wix web app and collect bitcoin payments in my country?", a: "CoinGate supports 170+ countries listed here." },
              { q: "Are there any fees for accepting crypto with the Wix web app?", a: "Accept cryptocurrency payments with a little 1% fee for a processed transaction." },
              { q: "How can I test the Wix web app functionality?", a: "Sign up for the CoinGate Sandbox to test the services in a safe environment." },
              { q: "Does it take long to withdraw the funds collected via the Wix web app?", a: "Withdrawals are processed recurringly. SEPA payouts might take 1-2 business days to go through." },
