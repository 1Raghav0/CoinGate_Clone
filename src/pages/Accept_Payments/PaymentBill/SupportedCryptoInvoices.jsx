    ...
    <section className="bg-gray-50 py-20 px-6">
      <div className="max-w-7xl mx-auto bg-white rounded-4xl p-10 md:p-16 text-center">
        ...
        <p className="text-xs tracking-widest uppercase text-gray-400 mb-4">
          Digital Currency Invoicing
        </p>

        {/* HEADING */}
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] leading-tight mb-6">
          Send crypto invoices in various digital <br className="hidden sm:block" />
          currencies
        </h2>

        {/* SUBTEXT */}
        <p className="text-gray-500 max-w-2xl mx-auto mb-10">
          Your recipients can choose their preferred payment option when they
          receive the invoice.
        </p>
...
export default SupportedCryptoInvoices;
