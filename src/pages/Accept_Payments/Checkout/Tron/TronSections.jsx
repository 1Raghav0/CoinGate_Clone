    ...
    <div className="space-y-8 bg-gray-50 py-20">
      ...
      <section className="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-10 md:p-16 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] leading-tight">
            One of the best Tron payment gateways out there
          </h1>

          <p className="text-gray-500 text-lg">
            Receive TRX payments with a powerful API, e-commerce plugins, email billing, and more solutions for collecting payments. Enjoy the benefits of converting funds to a local fiat currency.
          </p>
      ...
      <div className="max-w-3xl mb-20 mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-4 leading-tight">
          Set up TRX payment processing in a convenient way
        </h2>

        <p className="text-gray-300 mt-6 text-lg leading-relaxed">
          CoinGate’s TRON payment solutions are tailored for each and every type of business.
        </p>

        <p className="text-gray-300 mt-4 text-base leading-relaxed">
          Install a simple payment plugin within minutes, send bills manually, or use a programmable API for building custom-made integrations with our TRX payment gateway – whatever works best for you.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            Test our TRX payment tools in a safe environment.
          </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            Send invoices via email or direct link that can be paid with TRX.
          </p>
          <span className="text-green-500 text-sm cursor-pointer">
            Check out billing →
          </span>
      ...
      <section className="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-10 md:p-16 text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] mt-4">
          TRON withdrawals made simple
        </h2>

        <p className="text-gray-500 mt-6 max-w-2xl mx-auto text-lg">
          Withdrawing your TRX funds with FinPE is simple. Set the amount, destination, and timing for a seamless transaction experience.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16 max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <h4 className="font-semibold text-left text-[#0b1121]">
              Settle TRX to another crypto
            </h4>
            <p className="text-gray-500 text-left text-sm">
              Change your payout settings to receive BTC or other coins. when you get TRX, simply change your payout settings.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-left text-sm">
              Withdraw collected TRX payments directly to your TRX wallet.
            </p>
          </div>
        </div>
      </section>
