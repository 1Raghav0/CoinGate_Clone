    ...
    <div className="space-y-8 bg-gray-50 py-20">
      ...
      <section className="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-10 md:p-16 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] leading-tight">
            One of the best Solana payment gateways out there
          </h1>

          <p className="text-gray-500 text-lg">
            Get paid in SOL with a powerful API, e-commerce plugins, email billing, and other solutions for collecting payments. Enjoy the benefits of converting funds to a local fiat currency.
          </p>
      ...
      <div className="max-w-3xl mb-20 mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-4 leading-tight max-w-2xl mx-auto">
          Setup SOL payment processing in a convenient way
        </h2>
        <p className="text-gray-300 mt-4 text-base leading-relaxed max-w-2xl mx-auto">
          CoinGate’s Solana payment solutions are tailored for each and every type of business. 
        </p>

        <p className="text-gray-300 mt-4 text-base leading-relaxed max-w-2xl mx-auto">
          Install a simple payment plugin within minutes, send bills manually, or use a programmable API for building custom-made integrations with our SOL payment gateway – whatever works best for you.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <h3 className="text-lg font-semibold">Solana Payment Sandbox</h3>
          <p className="text-gray-400 text-sm">
            Test how to recieve SOL payments in a safe environment.
          </p>
        ...
        <div className="space-y-4">
          ...
          <h3 className="text-lg font-semibold">Solana Payment Plugins</h3>
          <p className="text-gray-400 text-sm">
            Accept Solana (SOL) payments with using plugins and extensions developed for mainstream e-commerce platforms.
          </p>
          <span className="text-green-500 text-sm cursor-pointer">
            See all Plugins →
          </span>
      ...
      <section className="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-10 md:p-16 text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] mt-4">
          Solana withdrawals made simple
        </h2>

        <p className="text-gray-500 mt-6 max-w-2xl mx-auto text-lg">
          Withdrawing your SOL funds with CoinGate is simple. Set the amount, destination, and timing for a seamless transaction experience.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16 max-w-3xl mx-auto">
          <div className="space-y-4">
            ...
            <h4 className="font-semibold text-left text-[#0b1121]">
              Convert SOL Coin to fiat currency
            </h4>
            <p className="text-gray-500 text-left text-sm">
              SOL payments can be exchanged to EUR or GBP and sent to your bank.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h4 className="font-semibold text-left text-[#0b1121]">
              Settle SOL to another crypto
            </h4>
            <p className="text-gray-500 text-left text-sm">
              Change your payout settings to receive BTC or other coins. when you get SOL, simply change your payout settings.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h4 className="font-semibold text-left text-[#0b1121]">
              Keep SOL in its original form
            </h4>
            <p className="text-gray-500 text-left text-sm">
              Withdraw collected SOL payments directly to your SOL wallet.
            </p>
          </div>
        </div>
      </section>
