      ...
      <div className="max-w-7xl mx-auto bg-white rounded-3xl p-6 md:p-12 shadow-sm">
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-xs text-gray-400 md:text-lg font-semibold uppercase">Book a demo</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] mb-4">
              Start using Solana payment processor today!
            </h2>

            <p className="text-gray-500 mb-8 max-w-md">
              Want to learn more about accepting SOL payments? Book a demo call with our sales team we’ll walk you through it!
            </p>
