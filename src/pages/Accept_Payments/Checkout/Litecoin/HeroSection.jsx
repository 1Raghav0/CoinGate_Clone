...
const HeroSection = () => {
  ...
  "Convert LTC to BTC, ETH, XRP, SOL & other cryptocurrencies",
  "LTC-to-fiat payouts (USD, EUR, GBP) to bank account",
  "Supporting 59 countries & more to come",
  "Industry leading Litecoin refund system",
    ...
    <section className="bg-[#0b1121] mt-20 text-white font-sans overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-24">
          ...
          <div className="text-sm text-gray-400 mb-10 flex items-center gap-2">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Accept Litecoin</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="space-y-6 max-w-xl">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Accept Litecoin payments with our flexible and multi-functional LTC payment processor for SMBs and large enterprieses. 
              </p>
      ...
      <div className="max-w-7xl mx-auto rounded-4xl p-10 md:p-16 text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#0b1121] leading-tight mb-6 max-w-3xl mx-auto">
          Litecoin payment plugins from FinPE
        </h2>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] leading-tight">
           Why accept LTC payments?
          </h2>
          <p className="text-gray-500 mt-4 text-sm md:text-lg">
            Here's what our clients say about using LTC payment gateway.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-[2.5rem] px-10 py-16 md:px-16 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="lg:w-1/2">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-500 text-sm md:text-base mb-8">
            ...
            <li>
              Provide your LTC wallet or other payout (withdrawal) address
            </li>
            <li>
              Collect Litecoin and other crypto payments automatically
            </li>
          </ol>
        ...
        <div className="lg:w-1/2 flex justify-center">
            <img
              src="https://cdn.coingate.com/uploads/2023/09/10063805/ltc-image-1.png"
              alt="Litecoin"
