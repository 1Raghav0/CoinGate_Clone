...
const HeroSection = () => {
  ...
  "Convert BNB to BTC, ETH, XRP, SOL, USDC & other cryptocurrencies",
  "BNB-to-fiat payouts (USD, EUR, GBP) to bank account",
  "Supporting 59 countries & more to come",
  "Refund BNB transactions",
    ...
    <section className="bg-[#0b1121] mt-20 text-white font-sans overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-24">
          ...
          <div className="text-sm text-gray-400 mb-10 flex items-center gap-2">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Accept Binance Coin (BNB) payments</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="space-y-6 max-w-xl">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Accept Binance Coin (BNB) payments or other cryptocurrencies with a flexible and multi-functional crypto payment processor for e-commerce websites.
              </p>
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-4xl p-10 md:p-16 text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0b1121] leading-tight mb-6">
          Accept payments in BNB and other cryptocurrencies
        </h2>
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-[2.5rem] px-10 py-16 md:px-16 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="lg:w-1/2">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-500 text-sm md:text-base mb-8">
            ...
            <li>
              Provide your BNB wallet or other payout (withdrawal) address
            </li>
            <li>
              Collect Binance Coin and other crypto payments automatically
            </li>
          </ol>
