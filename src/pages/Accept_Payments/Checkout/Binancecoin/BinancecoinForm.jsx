        ...
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-500 mb-8 max-w-md">
              Our sales team is available to assist with any questions you may have, even the ones that make you scratch your head. Don’t hesitate to reach out!
            </p>
...
export default BinancecoinForm;
